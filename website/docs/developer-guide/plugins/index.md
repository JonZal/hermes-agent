...
| [`pre_api_request`](../../user-guide/features/hooks.md#api-request-observer-hooks) | Before each main or auxiliary provider attempt (several per turn when the model calls tools) | `session_id: str, model: str, provider: str, base_url: str, api_mode: str, api_call_count: int, message_count: int, tool_count: int, approx_input_tokens: int, max_tokens: int, request: dict` | ignored |
| [`post_api_request`](../../user-guide/features/hooks.md#api-request-observer-hooks) | After a main or auxiliary provider attempt returns | `pre_api_request` fields plus `api_duration: float, finish_reason: str, response_model: str \| None, usage: dict, response: dict, assistant_content_chars: int, assistant_tool_call_count: int` | ignored |
| [`api_request_error`](../../user-guide/features/hooks.md#api-request-observer-hooks) | A main or auxiliary provider attempt raised | correlation fields plus `status_code: int \| None, retry_count: int \| None, max_retries: int \| None, retryable: bool \| None, reason: str \| None, error: dict, request: dict` | ignored |
