...
def _call_fallback_candidate_sync(
    ...
    def _send_recovering(
        ...
        return send_with_parameter_rungs(
            lambda c, kw: _send(c, kw, dest, attempt_reason=attempt_reason),
            client, request_kwargs, task=task)
    try:
        ...
        if retry is not None:
            ...
            try:
                return _send_recovering(
                    *retry, attempt_reason="fallback_retry:refreshed_credentials"
                )
